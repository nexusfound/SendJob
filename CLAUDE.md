...
> This file lives at `ai-project/sendjob/CLAUDE.md`.
> Core engine is shared at `ai-project/.gaai/core/`.
> Project context is local at `ai-project/sendjob/.gaai/project/`.

---

## You Are Operating Under GAAI Governance

This project uses the **GAAI framework**. Read `../.gaai/core/GAAI.md` first.
